 ...
 */
public class RequestedServicesListWithAddressAdapter extends RecyclerView.Adapter<RequestedServicesListWithAddressAdapter.PlanViewHolder> {

    private Context self;
    ArrayList<GroupingAddress> requestList = new ArrayList<>();
    ...
    public RequestedServicesListWithAddressAdapter(Context context, ListOfRequestFragment fragment, SharedPreferences sharedpreferences, SharedPreferences.Editor editor, GlobalClass globalClass, ArrayList<GroupingAddress> requestList) {
        this.self = context;
    ...
    public void onBindViewHolder(PlanViewHolder holder, final int position) {
        myHolder = holder;
        if (!requestList.get(position).Address.trim().equalsIgnoreCase("")) {
            myHolder.ll_address.setVisibility(View.VISIBLE);
            myHolder.tvAddressTitle.setText(requestList.get(position).Address);
        } else {
            myHolder.ll_address.setVisibility(View.GONE);
        }
