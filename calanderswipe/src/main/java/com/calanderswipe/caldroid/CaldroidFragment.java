package com.calanderswipe.caldroid;
...
import com.calanderswipe.R;
import com.calanderswipe.infiniteviewpager.InfinitePagerAdapter;
import com.calanderswipe.infiniteviewpager.InfiniteViewPager;
...
public class CaldroidFragment extends DialogFragment {
    ...
    protected int ALLOW_SHOW_MONTHS = 5;
    ...
    private String[] months_list = {"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"};
     ...
     */
    protected boolean enableSwipe = true, enableSwipeLeft = true, enableSwipeRight = true;
    ...
    private void setLeftRightSwipe() {
        dateViewPager.setEnabledLeft(enableSwipeLeft);
        dateViewPager.setEnabledRight(enableSwipeRight);
    }
    ...
    public void setCalendarDateTime(DateTime dateTime) {
        ...
        int diffYear = year - cal.get(Calendar.YEAR);
        int diffMonth = diffYear * 12 + month - (cal.get(Calendar.MONTH) + 1);

        if (dateViewPager != null) {
            if (diffMonth <= 0) {
                enableSwipeLeft = false;
                enableSwipeRight = true;
            } else if (diffMonth >= ALLOW_SHOW_MONTHS) {
    ...
    protected void refreshMonthTitleTextView() {
        ...
        monthTitleTextView.setText(months_list[month - 1]);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        calendar_left_arrow = (ImageView) view.findViewById(R.id.calendar_left_arrow);
        calendar_right_arrow = (ImageView) view.findViewById(R.id.calendar_right_arrow);
